...
const youtube = new YouTube(""); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = ""; ///تعديل اساسي سوي اي بي اي جديد
...
قناة مصمم البوت : https://www.youtube.com/channel/UCqfKbAJLR5EVTd7vwinolfQ
رابط سيرفر المساعده : <https://discord.gg/pg7PAM>
رابط ادخال البوت لسيرفرك : <https://discord.com/oauth2/authorize?client_id=747755259228585986&permissions=8&scope=bot>
`);
        })
        .then(e => {
          message.react("✅");
...
client.on("message", message => {
  if (message.content === "هلا") {
    message.channel.send("**:heart:هلوات حبيبي:heart:**");
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "اشتري")) {
    if (!message.channel.guild) return;
    if (message.author.bot) return;
    let channel = message.guild.channels.find(gg => gg.name === "تقديم-الشراء🔖");
    if (!channel)
      return message.reply(
        "**لانشاء روم الشراء $room3 من فضلك اكتب الامر**"
      );
    if (channel) {
      message.channel.send(message.member + ", **:timer:**").then(m => {
        m.edit(message.member + ", **:pencil:اسمك**");
        m.channel
          .awaitMessages(m1 => m1.author == message.author, {
            maxMatches: 1,
            time: 60 * 1000
          ...
          .then(m1 => {
            ...
            m1.delete();
            m.edit(message.member + ", **:timer:**").then(m => {
              m.edit(message.member + ", **هل تريد الشراء من متجر السيرفر او شراء من متجر الرتب؟**");
              setTimeout(() => {
                m.delete();
              }, 10000);
              m.channel
                ...
                .then(m2 => {
                  ...
                  message.channel
                    .send(message.member + ", **:timer:**")
                    .then(m => {
                      m.edit(message.member + ", **:thinking:ماذا تريد ان تشتري؟**");
                      setTimeout(() => {
                        m.delete();
                      }, 10000);
                      m.channel
                        ...
                        .then(m3 => {
                          ...
                          message.channel
                            ...
                            .then(m => {
                              m.edit(
                                message.member + ", **كم معك كريديت:credit_card:؟**"
                              );
                              setTimeout(() => {
                                m.delete();
                              }, 10000);
                                          ...
                                          m.edit(
                                            ...
                                            setTimeout(() => {
                                              let embed = new Discord.RichEmbed()
                                                ...
                                                .addField(
                                                  "**`هل يريد الشراء من متجر السيرفر او شراء من متجر الرتب؟`**",
                                                  `${age}`,
                                                  true
                                                )
                                                .addField(
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "room3")) {
    ...
    if (!message.member.hasPermission("`MANAGE_CHANNELS"))
      return message.reply("**تحتاج الى `MANAGE_CHANNELS`**");
    message.guild.createChannel("تقديم-الشراء🔖", "text").then(c => {
      c.overwritePermissions(message.guild.id, {
        SEND_MESSAGES: false
      });
    });
    message.channel.send("**✅ تم انشاء روم تقديم-الشراء🔖 بنجاح**");
  }
});
